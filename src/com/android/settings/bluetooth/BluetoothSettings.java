...
//$_rbox_$_modify_$_lijiehong begin:add to support checkbox
...
public final class BluetoothSettings extends DeviceListPreferenceFragment {
    ...
    //$_rbox_$_modify_$_lijiehong for Bluetooth switch checkbox,add by lijiehong
    ...
    //$_rbox_$_modify_$_lijiehong add by lijiehong to support checkbox
    ...
    void onOtherPreferenceClick(PreferenceScreen preferenceScreen,
        ...
        if(preference == mBluetoothCheckBox){//sync bluetooth switch ,add by ljh
...
//$_rbox_$_modify_$ end
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //$_rbox_$_modify_$_lijiehong add by ljh for adding a checkbox switch
        insertCheckbox();
        //$_rbox_$_modify_$ end
    }
    ...
    //$_rbox_$_modify_$_lijiehong change by lijiehong to support checkbox
