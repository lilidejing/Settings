...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference instanceof PreferenceScreen) {
            ...
            if (preference instanceof SpellCheckersPreference) {
            	final SpellCheckersPreference spellchecker = (SpellCheckersPreference) preference;
            	spellchecker.onCheckChanged();
            } else if (preference instanceof InputMethodPreference) {
            	final InputMethodPreference inputmethodchecker = (InputMethodPreference) preference;
            	inputmethodchecker.onCheckChanged();
            }
