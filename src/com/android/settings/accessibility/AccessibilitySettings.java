...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    private final String TAG = "AccessibilitySettings";
    ...
    private void checkDisabledItems(){//check from global config.xml .add by chenxiao
        ...
        if (mSystemsCategory!=null && getResources().getBoolean(
			...
			if (findPreference(CAPTIONING_PREFERENCE_SCREEN) != null
        			&& getResources().getBoolean(R.bool.config_enableCaptioningPreference) == false){
        	Log.d(TAG,"---removing "+CAPTIONING_PREFERENCE_SCREEN);
                mSystemsCategory.removePreference(findPreference(CAPTIONING_PREFERENCE_SCREEN));
        	}
