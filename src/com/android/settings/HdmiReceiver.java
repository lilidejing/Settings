...
public class HdmiReceiver extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent){
        ...
        if (intent.getAction().equals(ACTION)){
			...
			boolean mstate = plugged;
			Log.d(TAG,"HdmiReceiver  plugged = "+mstate);
			String text=context.getResources().getString((mstate==true)?R.string.hdmi_connect:R.string.hdmi_disconnect);
